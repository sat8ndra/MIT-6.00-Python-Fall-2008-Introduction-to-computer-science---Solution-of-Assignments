...
# in pick_best_word scenario the time complexity
# is quadratic in ie. len(hand)* len(hand)^2   O(n^2)
# in pick_best_word_faster the time complexity is also quadratic
# len(hand)*len(hand)log(len(hand))
# while implemantion of pick_best_word_faster is much more time complex
#
